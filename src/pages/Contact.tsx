              ...
              <AnimateOnScroll animation="slide-right" className="order-2 lg:order-2">
                <div className="space-y-8">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground">
                          Innere Cramer-Klett-Straße 17<br />
                          90403 Nürnberg
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <ul className="text-muted-foreground space-y-1 text-sm">
                          <li>Mo - So: 00:00 - 24:00</li>
                          <li>Nie: Geschlossen</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="aspect-video rounded-sm overflow-hidden border border-border mt-8">
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2593.523148145306!2d11.084983776892695!3d49.45572905848437!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x479f571701651dab%3A0x406d7afc924bbf34!2sFadeFabrik!5e0!3m2!1sde!2sde!4v1769782427230!5m2!1sde!2sde"
                      width="100%"
                      height="100%"
